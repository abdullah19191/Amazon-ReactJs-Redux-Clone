...
<CircularProgress/>
  ...
  return (
    <div className="w-full  grid grid-cols-4 gap-10 mx-auto px-4">
      {state.product.data &&
        state.product.data.map((e) => {
          return (
            <div className="bg-white border-1 h-auto hover:border-transparent hover:shadow-xl relative duration-200  border-gray-200 py-6 z-30 shadow flex flex-col">
              <div className="">
