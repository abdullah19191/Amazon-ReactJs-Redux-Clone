  ...
  return (
    <div className='w-full bg-[#131139] h-9 text-white px-4 flex items-center'>
      <ul className='flex items-center tracking-wide text-sm gap-4'>
        <li className='headerHover flex gap-1 items-center' onClick={()=> setSidebar(true)}><MenuIcon/>All</li>
                ...
                <div className=" w-full h-full relative">
                  <div className=" bg-white w-[350px] h-full border border-black">
                      <div className=" w-full bg-[#131921] text-white py-2 px-6 flex items-center gap-4">
                           <AccountCircleIcon/>
                           <h1 className=' font-bold text-md tracking-wide'>Hellow, Sign In</h1>
                      </div>
                      <div className="">
                        <h3 className=' text-lg  font-bold mb-1 px-6'>Digital Content & Devices</h3>
                      </div>
                  </div>
                </div>
            </div>
