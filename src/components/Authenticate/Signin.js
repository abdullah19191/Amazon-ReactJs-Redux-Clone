        ...
        <div className="flex flex-col items-center justify-center">
          <form className=" border-solid border-2 px-10 py-30 bg-white shadow-lg mt-[-50px] rounded-xl lg:w-3/12">
            ...
            <div className="flex flex-col lg:w-11/12 w-[110%]">
              ...
              <input type="password" name="password" onChange={addData} value={logdata.password} placeholder="At least 6 char" class="relative mb-2  p-2  border-2  outline-none rounded-md"></input>
            </div>
            <button className=" inline-block font-medium bg-gradient-to-r from-[#f7dfa5] to-[#f0c14b]  p-2 rounded-sm mt-2 cursor-pointer border-2 border-[#9c7e31] border-solid mb-7 h-10 w-full   text-[#111] bg-[#f3d078] outline-none ">Continue</button>
          </form>
